...
export default function UserGenarateQuery() {
  ...
  return (
    <div className="mt-12 mb-8 flex flex-col gap-12 min-w-full">
      ...
      <Card>
        <CardHeader variant="gradient" style={{ backgroundColor: "#1F50A2" }} className="mb-8 p-6 text-white">
          Genarate Query
        </CardHeader>
              ...
              (
                <Box px={'10%'} py={'5%'} gap={5} display={'flex'} flexDir={'column'}>
                  ...
                  <FormControl>
                    ...
                    <Button className="bg-[#1F50A2]">Submit</Button>
                  </FormControl>
                </Box>
              )
              //       currentStep === 1 ?
