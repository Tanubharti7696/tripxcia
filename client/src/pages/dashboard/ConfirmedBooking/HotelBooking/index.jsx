...
export default function UserHotelBooking({ queries }) {
        ...
        <Card>
            ...
            <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
                <table className="w-full min-w-[640px] table-auto">
                    <thead>
                        <tr>
                            {["SL", "ID", "Client Name", "Service", "Status", "Hotel Name", "Check-in Date", "Action"].map((el) => (
                        ...
                        {queries.length > 0 ? (
                            queries.map((row, index) => (
                                <tr key={row._id}>
                                    ...
                                    <td className="py-3 px-5">{row.hotelName}</td>
                                    <td className="py-3 px-5">{row.checkInDate}</td>
